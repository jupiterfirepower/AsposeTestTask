...
dapr run --app-id "gateway-service" --app-port "5004" --dapr-grpc-port "50040" --dapr-http-port "5040" --components-path "./components" -- dotnet run --project ./src/Services/microservice.gateway/microservice.gateway.csproj --urls="http://+:5241"
